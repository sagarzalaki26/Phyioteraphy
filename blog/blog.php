    ...
    <div class="min-h-screen flex">
        <aside class="w-64 bg-white border-r border-gray-200 fixed h-full">
            ...
            <nav class="mt-6 px-4">
                ...
                <a href="blog.php" class="flex items-center px-4 py-3 text-green-600 bg-green-50 rounded-lg mb-2">
        ...
        <div class="flex-1 ml-64">
            ...
            <main class="p-6">
                <div class="mb-6 flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-900">All Posts</h2><a href="Add-blog.php"
                        class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg flex items-center"><i
                            class="fas fa-plus mr-2"></i>New Post</a>
                </div>
